...
addon.L = {
	...
	["hide buffs"] = "隐藏所有增益图标",
	["hide debuffs"] = "隐藏所有减益图标",
	["hide dispels"] = "隐藏所有驱散图标",
	...
	["sync dual-talent settings"] = "同步双天赋设置",
	["sync dual-talent enabled"] = "已|cff00ff00启用|r双天赋同步。",
	["sync dual-talent disabled"] = "已|cffff0000禁用|r双天赋同步。",
	["sync dual-talent tooltip"] = "为模块|cff00ff00%s|r启用或禁用双天赋同步，此设置仅作用于当前角色。",
	...
	["hide raid target icon"] = "隐藏队伍标记图标",
