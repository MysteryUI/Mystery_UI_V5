...
addon.L = {
	...
	["sync dual-talent settings"] = "同步雙天賦設置",
	["sync dual-talent enabled"] = "已|cff00ff00啟用|r雙天賦同步。",
	["sync dual-talent disabled"] = "已|cffff0000禁用|r雙天賦同步。",
	["sync dual-talent tooltip"] = "為模塊|cff00ff00%s|r啟用或禁用雙天賦同步，此設置僅作用於當前角色。",
