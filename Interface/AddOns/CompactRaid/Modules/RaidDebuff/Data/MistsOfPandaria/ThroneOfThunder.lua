...
module:RegisterDebuff(TIER, INSTANCE, BOSS, 136817)
...
-- Tortos (825)
BOSS = 825
module:RegisterDebuff(TIER, INSTANCE, BOSS, 134091)

-- Megaera (821)
BOSS = 821
module:RegisterDebuff(TIER, INSTANCE, BOSS, 137731)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 139909)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 139841)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 139839)

-- Ji-Kun (828)
BOSS = 828
module:RegisterDebuff(TIER, INSTANCE, BOSS, 140092)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 134256)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 134366)

-- Durumu the Forgotten (818)
BOSS = 818
module:RegisterDebuff(TIER, INSTANCE, BOSS, 133767)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 133768, 4)
...
-- Dark Animus (824)
BOSS = 824
module:RegisterDebuff(TIER, INSTANCE, BOSS, 138480)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 138618)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 138569)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 138659, 4)
module:RegisterDebuff(TIER, INSTANCE, BOSS, 136954)
