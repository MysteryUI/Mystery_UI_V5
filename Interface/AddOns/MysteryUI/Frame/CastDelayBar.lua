...
function C:OnInitialize()	
	...
	self.delayText:SetPoint("RIGHT", CastingBarFrame, "RIGHT", 26, 2);
...
CastingBarFrame:SetPoint("TOP", UIParent, "CENTER", 0, -200)
CastingBarFrame:ClearAllPoints()
CastingBarFrame:SetPoint("BOTTOM", UIParent, "CENTER", 0, -210)
